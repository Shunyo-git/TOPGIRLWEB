<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage/Admin_1.master" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="Admin_ProductList" %>
...
<table id="table1" align="center" border="0" cellpadding="3" cellspacing="1" class="tableBorder"
        ...
        <tr>
            <td align="right" class="Forumrow" style="height: 28px">
                ...
                <asp:LinkButton ID="lbtnNew" runat="server" OnClick="lbtnNew_Click">新增商品</asp:LinkButton></td>
        </tr>
        <tr>
            <td class="Forumrow">
                <font face="新細明體">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="False" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="類別"  SortExpression="CategoryID">
                             ...
                             <asp:BoundField DataField="SKU" HeaderText="商品代碼" SortExpression="SKU">
                        ...
                        <EmptyDataTemplate>
                            <asp:Label ID="Label10" runat="server" Text="Label">無商品資料！</asp:Label>
                        </EmptyDataTemplate>
