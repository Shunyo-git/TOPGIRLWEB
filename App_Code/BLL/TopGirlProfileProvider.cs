...
namespace TopGirl.Profile
{
    public sealed class TopGirlProfileProvider : ProfileProvider
    {
        ...
        private static readonly ISQLProfileProvider dal = DataAccessHelper.CreateTopGirlProfileProvider();
        // Private members
        private const string ERR_INVALID_PARAMETER = "Invalid Profile parameter:";
        private const string PROFILE_ACCOUNT = "MemberInfo";
        private static string applicationName = "TopGirl 1.0";
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "TopGirl Custom Profile Provider");
            }

            if (string.IsNullOrEmpty(name))
                name = "TopGirlProfileProvider";
