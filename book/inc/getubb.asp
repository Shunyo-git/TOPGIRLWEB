...
字體大小<select name="size" onChange="if(this.options[this.selectedIndex].value!=''){showsize(this.options[this.selectedIndex].value);this.options[0].selected=true;}else {this.selectedIndex=0;}">
	<option value="1">1</option>
	<option value="2">2</option>
	<option value="3" selected>3</option>
	<option value="4">4</option>
</select>
                                &nbsp;&nbsp;&nbsp;<font face="細明體" color=#333333>顏色：</font>
              ...
              <option style="background-color:#FFFFFF" selected>預設:黑</option>
...
<br>
<img onclick=Cbold() src="images/ubbpic/bold.gif" width="22" height="22" alt="粗體" border="0">
<img onclick=Citalic() src="images/ubbpic/italicize.gif" width="23" height="22" alt="斜體" border="0">
<img onclick=Cunder() src="images/ubbpic/underline.gif" width="23" height="22" alt="下劃線" border="0">
<img onclick=Ccenter() src="images/ubbpic/center.gif" width="22" height="22" alt="居中" border="0">
<img onclick=Curl() src="images/ubbpic/icon_editor_url.gif" width="22" height="22" alt="插入連結" border="0">
<img onclick=Cemail() src="images/ubbpic/email.gif" width="23" height="22" alt="插入Email" border="0">
<img onclick=Cimage() src="images/ubbpic/image.gif" width="23" height="22" alt="插入圖片" border="0">
<img onclick=Cswf() src="images/ubbpic/swf.gif" width="23" height="22" alt="Flash檔案" border="0">
<img onclick=Cquote() src="images/ubbpic/quote.gif" width="23" height="22" alt="引用" border="0">
<img onclick=Cdir() src="images/ubbpic/Shockwave.gif" width="23" height="22" alt="Shockwave檔案" border="0">
<img onclick=Crm() src="images/ubbpic/rm.gif" width="23" height="22" alt="realplay視訊檔案" border="0">
<img onclick=Cwmv() src="images/ubbpic/mp.gif" width="23" height="22" alt="Media Player視訊檔案" border="0">
<img onclick=Cmov() src="images/ubbpic/qt.gif" width="23" height="22" alt="QuickTime視訊檔案" border="0">

<IMG onclick=Cfly() height=22 alt=飛行字 src="images/ubbpic/fly.gif" width=23 border=0>
<IMG onclick=Cmarquee() height=22 alt=移動字 src="images/ubbpic/move.gif" width=23 border=0>
<IMG onclick=Cguang() height=22 alt=發光字 src="images/ubbpic/glow.gif" width=23 border=0>
<IMG onclick=Cying() height=22 alt=陰影字 src="images/ubbpic/shadow.gif" width=23 border=0>